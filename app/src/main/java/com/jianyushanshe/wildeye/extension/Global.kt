...
import com.jianyushanshe.wildeye.ui.common.ui.ShareDialogFragment
 ...
 */
val sharedPreferences: SharedPreferences = WildEyeApp.context.getSharedPreferences(GlobalUtil.appPackage + "_preferences", Context.MODE_PRIVATE)
 ...
 * @param shareContent 分享内容
 */
fun dialogShare(activity: Activity, shareContent: String) {
